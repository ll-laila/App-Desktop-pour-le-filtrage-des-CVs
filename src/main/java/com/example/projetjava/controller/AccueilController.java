    ...
    public void initialize() {
        ...
        for (int i = 0; i < listoffres.size(); i++) {
            ...
            if (recruteurs.size()!=0){
                Entreprise = new Label(recruteurs.get(0).getNomEntreprise());
            ...
            recruteurs = new RecruteurDaoImpl().getAllRecruteurs().stream().filter(p->p.getRandomValue()==Integer.parseInt(idoffer.getText())).toList();
